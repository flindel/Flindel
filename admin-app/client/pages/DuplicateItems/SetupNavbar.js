    ...
    return(
      <div className = 'containerPB'>
        <ul className="progressbarOnboard">
          <li className = {stepActiveArray[0]}><span>Setup</span></li>
          <li className = {stepActiveArray[1]}><span>Theme</span></li>
          <li className = {stepActiveArray[2]}><span>Approval</span></li>
          <li className = {stepActiveArray[3]}><span>Publish</span></li>
        </ul>
      </div>
    )
}
