                    ...
                    <div className="Search-fields">
                        ...
                        <div className="Search-block">
                            {/* {<p className = 'label'>Order Number: </p>} */}
                              <input type="text" className="p1" placeholder="Order Number" onChange={this.handleOrderNumChange} /><span onClick = {this.showOrderNumberInfo}><img src = "https://drive.google.com/uc?id=1muURA-zh3cbC2WLT0gX8nLRYLPilQujh"/></span>
                             {
                                 this.state.showOrderNumberInfo? (<p>Your order number can be found in your confirmation email</p>):null
                             }
                          ...
                          <div className="Search-block">
                              ...
                              <input type="text" className="p1" placeholder="Email or Phone Number" onChange={this.handleEmailChange} /><span onClick = {this.showEmailInfo}><img src = "https://drive.google.com/uc?id=1muURA-zh3cbC2WLT0gX8nLRYLPilQujh"/></span>
                              {
                                 this.state.showEmailInfo? (<p>This is the email or phone number associated with your order</p>):null
                             }
                          </div>
