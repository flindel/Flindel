...
class OnboardProcess extends Component {
    ...
    fetch(`${serveo_name}/collections?id=${encodeURIComponent(origCollectionId)}`, {
      ...
      .then(resData=> {
        ...
        if(resData.products.length != 0){
          ...
          if(loopCount < 10){ //Retries API call if nothing is returned, up to 10 times
            console.log("Retry get collection", loopCount);
            loopCount++;
            this.getOrigProducts(origCollectionId, loopCount);
          }else{
            console.error("Original products collection is empty or API error.");
          }
        }
      })
  ...
  render(props){
        ...
        <div>
          ...
          <center>
            <ol style={{
              ...
              <li style={text}>An unpublished duplicate of all products on your store, for “Get it Today” (These products will only be visible after setup is complete)</li>
              <li style={text}>A smart collection called "Original" containing all of your brand’s current products.</li>
              <li style={text}>A smart collection called "Get it Today" containing all products offered on “Get it Today”.</li>
              <li style={text}>A fulfillment service called “Flindel”. Used to fulfill “Get it Today” products.</li>
            </ol>
          </center>
          ...
          <center>
            <ol style={{
              ...
              <li style={text}>If any product variants have a weight of 0kg, it will be set to 0.1kg.</li>
            </ol>
          </center>
          <br/>
          <div>
            <Button variant="contained" onClick={() => {
              this.setup();
            }} color="secondary">Make Changes to Store</Button>
          </div>
          <br/>
          <br/>
        </div>
    ...
    if(this.state.step == 2 || this.state.step == 3){
      page = (
      <div>
        <h1>Please follow the steps below to create UI elements for Get it Today and Flindel Returns.</h1>
        <center>
          ...
          <ol style={{
            ...
            <li style={text}>Create a duplicate of your current store theme</li>
            <img src="https://imgur.com/zIqLR98.png" title="source: imgur.com" width = '400px' />

            <li style={text}>Press "customize" located to the right of copy of your current store theme.</li>
            <img src="https://imgur.com/tydT5lP.png" title="source: imgur.com" width = '400px' />

            <li style={text}>Create custom element so users can navigate to the Get it Today product collection. Feel free to place Get it Today wherever works for your storefront. In the example below, we linked to Get it Today in the navigation bar.</li>
            <img src="https://imgur.com/Yg8zrCr.png" title="source: imgur.com" width = '400px' />

            <li style={text}>For Flindel Returns, please inform us if your refund policy is located outside of Shopify’s legal pages, located within the settings of Shopify admin.</li>

            <li style={text}>Exit the theme editor and navigate back to your theme library.</li>
            <img src="https://imgur.com/tydT5lP.png" title="source: imgur.com" width = '400px' />

            <li style={text}>To the right of the copy of your store theme click actions, and then select “Preview” from the drop down menu.</li>
            <img src="https://imgur.com/VxSJfBr.png" title="source: imgur.com" width = '400px' />

            <li style={text}>In the bottom right of the preview page, select “Share preview”</li>
            <img src="https://imgur.com/dxnZK0f.png" title="source: imgur.com" width = '400px' />

            <li style={text}>Copy the link provided and send it to brandsupport@flindel.com</li>

            <li style={text}>Once your design has been approved you will be informed, and can move on to the last step.</li>
          </ol>
        </center>
        <br/>
        {(this.state.step == 3)?
        ...
        <div>
          ...
          <Button
            variant="contained"
            onClick={() => {
              alert("Please send brandsupport@flindel.com the link to your unpublished store theme.");
              this.completeStep(3);
            }}
            color="secondary"
            >
        ...
        <div>
          <center>
            <ol style={{
              ...
              <li style={text}>To the right of the copy of your store theme click actions, and then select “Publish” from the drop down menu.</li>
              <img src="https://imgur.com/VxSJfBr.png" title="source: imgur.com" width = '400px'/>
              <li style={text}>Immediately after publishing your store theme, press the “Publish” button located below to make Flindel Services available for your customers.</li>
