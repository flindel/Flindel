                ...
                <div>
                    ...
                    <fieldset className = 'SC'>
                        ...
                        {this.state.orderList.map((order,index)=>{
                            return <Order order={order} step = {2} changeOrderStatus = {this.changeOrderStatus.bind(this)}changeMessage = {this.changeMessage.bind(this)} serveoname = {serveoname} key={order.code +index}/>
                        })}
