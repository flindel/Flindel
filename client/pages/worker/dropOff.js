...
class DropOff extends Component {
  ...
  async loadHistory() {
    let temp = await fetch(
      `https://${serveoname}/return/dropoffSummary?id=${encodeURIComponent(
        this.state.workerID
      )}`,
      {
        method: "get"
  ...
  async selectOrder() {
    if (this.state.workerID != "") {
      ...
      let temp = await fetch(
        `https://${serveoname}/worker/check?id=${encodeURIComponent(
          this.state.workerID
        )}`,
        {
          method: "get"
  ...
  updateDB() {
    ...
    fetch(
      `https://${serveoname}/return/requested/receive?code=${encodeURIComponent(
        this.state.code
