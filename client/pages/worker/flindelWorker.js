        ...
        if (this.state.step == 1){
            return(
                <div>
                    ...
                    <br/>
                    <br/>
                    <h3 className = 'main'> Please select one of the buttons below to continue.</h3>
                    <br/>
                    <button className = 'main' onClick = {this.goSortingCenter}>SORTING CENTER</button>
                    <button className = 'main' onClick = {this.goDropOff}>DROP OFF</button>
                    <button className = 'main' onClick = {this.goAssemble}>ASSEMBLE ORDERS</button>
