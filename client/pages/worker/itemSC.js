...
class Item extends Component {
  ...
  async makeNewProduct() {
    ...
    if (pID != 0) {
      let temp = await fetch(
        ...
        }/products/GITinformation?varID=${encodeURIComponent(
          this.state.idNew
  ...
  async getItemInformation(varID) {
    let temp = await fetch(
      `https://${this.props.serveoname}/products/all?shop=${encodeURIComponent(
  ...
  async checkBlacklist() {
    ...
    let temp = await fetch(
      `https://${
        this.props.serveoname
      }/products/variant/productID?store=${encodeURIComponent(
        this.props.item.store
    ...
    let temp2 = await fetch(
      `https://${
        this.props.serveoname
      }/blacklist/exists?store=${encodeURIComponent(
        this.props.item.store
  ...
  async loadImage() {
    ...
    fetch(
      `https://${this.props.serveoname}/products/img?shop=${encodeURIComponent(
        this.props.item.store
